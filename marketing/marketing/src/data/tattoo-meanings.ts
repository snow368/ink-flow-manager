...
export const TATTOO_CATEGORIES: TattooCategory[] = [
  ...
  // ===== 13. SEA LIFE (4) — NEW CATEGORY =====
  {
    ...
    symbols: [
      ...
      },
      {
        ...
        customSections: [
          { heading: 'Great White, Hammerhead, or Whale Shark? Picking Your Species', text: "The species you choose shifts the meaning. A great white reads as pure power, dominance, and fearlessness — the apex of the food chain with no natural predator. A hammerhead reads as vision, perspective, and protective awareness, thanks to its wide-set eyes and near-360-degree field of view. A whale shark is the gentle giant: peace, calm, and quiet strength. A mako brings speed, agility, and swift adaptation; a tiger shark brings survival instinct and raw adaptability. Choose the species whose story matches your intent — or wear a shark-tooth (niho mano) pattern for pure protective symbolism without a full predator.", links: [
            { label: 'Great White Shark Tattoo Meaning', href: '/tattoo-meaning/ocean/great-white-tattoo-meaning' },
            { label: 'Hammerhead Shark Tattoo Meaning', href: '/tattoo-meaning/ocean/hammerhead-tattoo-meaning' },
            { label: 'Shark Tooth (Niho Mano) Tattoo Meaning', href: '/tattoo-meaning/ocean/shark-tooth-tattoo-meaning' },
          ] },
      ...
      {
        slug: 'great-white', name: 'Great White Shark', category: 'sea-life',
        gallerySvgs: ['shark-great-white.svg'],
        ...
        origin: 'Western surf and beach culture, Sailor Jerry American Traditional, Polynesian protector roots, modern pop-culture reclamation',
        ...
        variants: ['great white silhouette', 'great white and wave', 'great white open jaw', 'great white with compass', 'fine-line great white'],
        ...
        metaDescription: 'Great white shark tattoo meaning: raw power, dominance, reclaimed fear. Explore the science, the vulnerable paradox, Jaws legacy, and cultural roots.',
        relatedSymbols: ['shark', 'hammerhead', 'shark-tooth', 'whale'],
        faqs: [
      ...
      {
        slug: 'hammerhead', name: 'Hammerhead Shark', category: 'sea-life',
        gallerySvgs: ['shark-hammerhead.svg'],
        ...
        origin: 'Modern surf and dive culture, scientific fascination, Polynesian protector roots, conservation movement',
        culturalNotes: 'Where the great white is blunt force, the hammerhead is cunning awareness. Its "hammer" (the cephalofoil) is one of the ocean’s great evolutionary experiments — and wearing it signals that you value perception over raw power. In conservation circles the hammerhead has become a flagship for shark protection, because several species (scalloped, great, smooth) are among the most threatened of all sharks from the fin trade. A hammerhead can mean you see clearly, guard others, and stand apart.',
        variants: ['hammerhead silhouette', 'hammerhead and wave', 'hammerhead school', 'geometric hammerhead', 'hammerhead fine-line'],
        externalSource: 'https://www.britannica.com/animal/hammerhead-shark',
        sourceLabel: 'Britannica — Hammerhead Shark',
        metaDescription: 'Hammerhead shark tattoo meaning: vision, perspective, protective awareness. Explore the cephalofoil, the 360 myth, individuality, and threatened status.',
        relatedSymbols: ['shark', 'great-white', 'shark-tooth', 'whale'],
        faqs: [
      ...
      {
        slug: 'shark-tooth', name: 'Shark Tooth', category: 'sea-life',
        gallerySvgs: ['shark-tooth.svg'],
        ...
        origin: 'Polynesian (niho mano), Hawaiian (ʻaumākua), Samoan, Māori, Marquesan, modern surf and tribal revival',
        ...
        variants: ['niho pattern band', 'single shark tooth', 'shark tooth and wave', 'shark tooth spearhead', 'Marquesan shark tooth'],
        externalSource: 'https://www.polynesiantattoosymbols.com/shark-teeth-tattoo/',
        sourceLabel: 'Polynesian Tattoo Symbols — Shark Teeth',
        metaDescription: 'Shark tooth (niho mano) tattoo meaning: protection, courage, ancestral guidance. Explore Polynesian grammar, ʻaumākua, lokahi, and how to wear it respectfully.',
        relatedSymbols: ['shark', 'great-white', 'hammerhead', 'whale'],
        faqs: [
