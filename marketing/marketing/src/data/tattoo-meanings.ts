  ...
  // ===== 13. SEA LIFE (4) — NEW CATEGORY =====
  {
    ...
    symbols: [
      ...
      },
      {
        ...
        faqs: [
          { question: 'What does a shark tattoo symbolize?', answer: 'A shark tattoo symbolizes power, survival, fearlessness, focus, adaptability, and protection. As an apex predator it reads as unshakeable drive and the confidence to move through life without hesitation.' },
          ...
          { question: 'Are shark tattoos only for men?', answer: 'No. A shark is not gendered. For men it often reads as raw courage and dominance; for women it is more often chosen as fierce independence and self-reliance. Choose the posture and style that match your story.' },
          { question: 'Where did shark tattoos originate?', answer: 'Shark tattoo imagery traces back to Polynesian (tohu protector), Hawaiian (aumakua guardian), Maori, Western sailor tradition, and modern surf culture.' },
        ],
        customSections: [
