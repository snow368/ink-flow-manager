export const VOICE_COMMANDS: Record<string, Record<string, string>> = {
  en: {
    ...
    timer: 'announce_time', pause: 'pause_timer',
  ...
  es: {
    foto: 'take_photo', video: 'record_video', tiempo: 'announce_time', pausa: 'pause_timer',
  ...
  pt: {
    foto: 'take_photo', video: 'record_video', tempo: 'announce_time', pausa: 'pause_timer',
  ...
  de: {
    foto: 'take_photo', video: 'record_video', zeit: 'announce_time', pause: 'pause_timer',
  ...
  fr: {
    photo: 'take_photo', video: 'record_video', temps: 'announce_time', pause: 'pause_timer',
